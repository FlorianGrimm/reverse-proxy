...
public sealed record RouteConfig
{
    ...
    /// <see cref="ReverseProxyIEndpointRouteBuilderExtensions.MapReverseProxy(IEndpointRouteBuilder, Action{IReverseProxyApplicationBuilder}, Dictionary{string, Action{IEndpointConventionBuilder}}?)"/>.
    /// </summary>
