...
public sealed record TransportTunnelConfig {
    ...
    public CertificateRequestCollectionParameter ToParameter()
    {
        return new CertificateRequestCollectionParameter(
            Id: TunnelId,
            CertificateConfig: Authentication.ClientCertificate,
            CertificateConfigs: Authentication.ClientCertificates,
            CertificateCollection: Authentication.ClientCertificateCollection,
            CertificateRequirement: Authentication.CertificateRequirement
        );
    }
}
