...
public interface ITransportTunnelWebSocketAuthenticator
{
    ...
    /// <summary>
    /// Configure the options based on the authenticator and config. 
    /// </summary>
    /// <param name="config">The config of the transport.</param>
    /// <param name="options">The options to by configured.</param>
