...
internal static class EventIds
{
    ...
    // public static readonly EventId Z = new EventId(100, "Z");
    // public static readonly EventId Z = new EventId(101, "Z");
    // public static readonly EventId Z = new EventId(102, "Z");
    // public static readonly EventId Z = new EventId(103, "Z");
    // public static readonly EventId Z = new EventId(104, "Z");
    // public static readonly EventId Z = new EventId(105, "Z");
    // public static readonly EventId Z = new EventId(106, "Z");
