...
/// <summary>
/// Default implementation of <see cref="IHttpForwarderV2"/>.
/// </summary>
internal sealed class HttpForwarderV2 : IHttpForwarder, IHttpForwarderV2
{
    ...
    public HttpForwarderV2(ILogger<HttpForwarderV2> logger, TimeProvider timeProvider)
    {
    ...
    public ValueTask<ForwarderError> SendAsync(
        ...
        => SendAsync(context, destinationPrefix, httpClient, requestConfig, transformer, TunnelTransformer.Empty, CancellationToken.None);
    ...
    public ValueTask<ForwarderError> SendAsync(
        ...
        => SendAsync(context, destinationPrefix, httpClient, requestConfig, transformer, TunnelTransformer.Empty, cancellationToken);
...
#warning HERE Protocol
            ...
            try
            {
                ...
                (destinationRequest, requestContent, tryDowngradingH2WsOnFailure) = await CreateRequestMessageAsync(
                    context, destinationPrefix, transformer, tunnelTransformer, requestConfig, isStreamingRequest, activityCancellationSource);
                ...
                catch (HttpRequestException hre) when (tryDowngradingH2WsOnFailure)
                {
                    ...
                    (destinationRequest, requestContent, _) = await CreateRequestMessageAsync(
                        context, destinationPrefix, transformer, tunnelTransformer, config, isStreamingRequest, activityCancellationSource);
    ...
    private async ValueTask<(HttpRequestMessage, StreamCopyHttpContent?, bool)> CreateRequestMessageAsync(HttpContext context, string destinationPrefix,
        HttpTransformer transformer, TunnelTransformer tunnelTransformer, ForwarderRequestConfig? requestConfig, bool isStreamingRequest, ActivityCancellationTokenSource activityToken)
    {
        ...
        if (tunnelTransformer is not null)
        {
            await tunnelTransformer.TunnelTransformRequestAsync(context, destinationRequest, destinationPrefix, activityToken.Token);
        }
