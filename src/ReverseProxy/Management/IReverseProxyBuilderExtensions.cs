...
internal static class IReverseProxyBuilderExtensions
{
    ...
    public static IReverseProxyBuilder AddConfigManager(this IReverseProxyBuilder builder)
    {
        ...
        builder.Services.TryAddSingleton<LazyProxyConfigManager, LazyProxyConfigManager>();
    ...
    public static IReverseProxyBuilder AddProxy(this IReverseProxyBuilder builder)
    {
        ...
        builder.Services.TryAddSingleton<TransportForwarderHttpClientFactorySelector>();
        builder.Services.TryAddEnumerable(ServiceDescriptor.Singleton<ITransportForwarderHttpClientFactorySelector, TransportForwarderHttpClientFactory>());
    ...
    public static IReverseProxyBuilder AddHttpSysDelegation(this IReverseProxyBuilder builder)
    {
        ...
        builder.Services.AddSingleton<ILazyResolveIServerDelegationFeature, LazyResolveIServerDelegationFeature>();
